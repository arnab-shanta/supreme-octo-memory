...
class TaskRecyclerAdapter(tasksList: List<Tasks>, internal var context: Context) :
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        ...
        when (tasks.priority) {
            "Low" -> holder.item_priority.background =
                ContextCompat.getDrawable(context, R.color.colorPriorityLow)
            "Normal" -> holder.item_priority.background =
                ContextCompat.getDrawable(context, R.color.colorPriorityNormal)
            "High" -> holder.item_priority.background =
                ContextCompat.getDrawable(context, R.color.colorPriorityHigh)
        }
    ...
    inner class TaskViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        var priority: TextView = view.findViewById(R.id.tvPriority)
        var list_item: LinearLayout = view.findViewById(R.id.list_item) as LinearLayout
        var item_priority: LinearLayout = view.findViewById(R.id.item_priority)
    }
}
